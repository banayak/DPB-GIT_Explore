...
<s:form >
			...
			<div class="pageTitle"><span class="Header1">File Process Status</span></div>
			<hr />
			<p>
			  <label>The following are the details of the File Processing Id <s:property  value="procDpbID"></s:property>.</label>
			  </p>
