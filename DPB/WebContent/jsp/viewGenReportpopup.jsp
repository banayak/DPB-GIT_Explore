...
<s:form>
				...
				<div class="pageTitle"><span class="Header1">Report Process Status</span></div>
			<hr />
			<p>
			  <label>The following are the details of the Generate Report Processing Id <s:property  value="procDpbID"></s:property>.</label>
			  </p>
