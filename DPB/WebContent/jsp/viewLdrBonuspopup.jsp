...
<html>
<head>
<title>Leadership Bonus Process</title>
...
<s:form>
			<div class="pageTitle"><span class="Header1">Leadership Bonus Process Status</span></div>
			<hr />
			<p>
			  <label>The following are the details of the Leadership Bonus Processing Id <s:property  value="procDpbID"></s:property>.</label>
			  </p>
