...
public class ViewGenReportPopUpAction extends DPBAction{
	...
	private static DPBLog LOGGER = DPBLog.getInstance(ViewGenReportPopUpAction.class);
	private String actionForward = "";
	List<String> inpProcList;
	private int pdpb;
	public String viewGenReportpopup(){
		try
		{ 
			this.setMenuTabFocus(IWebConstants.FILE_PROCESSING_ID);
			actionForward="viewGenReportpopup";
