...
import com.mbusa.dpb.web.fileProcess.ViewFileProcessPopUpAction;
import com.mbusa.dpb.web.helper.IWebConstants;

public class ViewProcLdrBonusPopupAction extends DPBAction{
	...
	private static DPBLog LOGGER = DPBLog.getInstance(ViewProcLdrBonusPopupAction.class);
