 ...
 * Module Name				:   
 * Author					: Syntel 
 * Program Name				: IDPBCommonDAO.java
 * Program Version			: 1.0
...
public interface IDPBCommonDAO {
	...
	public void insertBonusCalculationRecord(List<BonusInfo> bnsInfo,boolean ldrsp);
	...
	public void updateBonusPaidStatusRecords(List<Integer> updateReocords,String paymentType, String userId,boolean ldrsp);
	public List<Integer>  retriveBonusPaidRecords(Date startDate,Date endDate,String paymentType,boolean ldrsp,Integer pgId);
	public List<VistaFileProcessing> retrieveRtlVehicleDataGivenPeriodAndType(java.sql.Date startDate, java.sql.Date endDate,List<String> vType,boolean isSpecial);
	...
	public void updateCalcDetails(List<Integer> calcId);
